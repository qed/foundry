...
> **Last updated**: 2026-02-21 (pre-Wave 1)
...
## Section 5: Worktree Instructions

> Include at the top of every prompt.

**IMPORTANT**: This is a git worktree. You are already on branch `phase-XXX`. Do NOT run `git checkout` or switch branches. Just build directly on the current branch.

---

## Section 6: Current Recommended Wave

> Updated by the Conductor after each wave merges.

**Wave 1** (in progress):
- Phase 017: Edit & Delete Ideas (Hall)
- Phase 026: Pattern Shop Database Schema (Shop)
- Phase 113: Organization Console (Admin)
- Phase 117: Real-Time Presence (Realtime)

**Wave 2** (after Wave 1 merges):
- Phase 061: Assembly Floor Database Schema (Floor)
- Phase 018: Tagging & Tag Management (Hall)
- Phase 027: Pattern Shop Page Layout (Shop)
- Phase 120: Project Archive & Cleanup (Admin)
