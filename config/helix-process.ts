...
const stage1Steps: StepConfig[] = [
  {
    ...
    description: 'Conduct interviews with key stakeholders to understand project goals, constraints, and success criteria.',
    evidenceRequirements: [
      { type: 'text', label: 'Interview Summary', description: 'Summary of stakeholder interviews and key findings', required: true },
    ],
    deliverables: ['Stakeholder interview notes', 'Key themes document'],
  },
  {
    key: '1.2',
    stageNumber: 1,
    ...
    description: 'Research the market landscape, competitors, and domain-specific considerations.',
    evidenceRequirements: [
      { type: 'text', label: 'Research Findings', description: 'Market and domain research findings', required: true },
    ],
    deliverables: ['Market analysis', 'Competitive landscape overview'],
  },
  {
    key: '1.3',
    stageNumber: 1,
    ...
    description: 'Define the core problem statement and project scope based on discovery findings.',
    evidenceRequirements: [
      { type: 'text', label: 'Problem Statement', description: 'Clear problem statement and scope definition', required: true },
    ],
    deliverables: ['Problem statement', 'Project scope document'],
  },
]
...
export const HELIX_STAGES: StageConfig[] = [
  {
    ...
    slug: 'discovery',
    title: 'Discovery',
    description: 'Understand the problem space, stakeholders, and project context.',
    steps: stage1Steps,
    gateDescription: 'All discovery deliverables completed and reviewed.',
  },
  {
    number: 2,
    slug: 'requirements',
